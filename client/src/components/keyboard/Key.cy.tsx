...
describe("<Key />", () => {
  ...
  it("should have width as given", () => {
    cy.mount(<Key value="T" onClick={() => {}} width={50} />);
  ...
  it("should have absent key style", () => {
    cy.mount(<Key value="T" onClick={() => {}} status="absent" />);
    cy.get("button").should(
      "have.css",
      "background-color",
      "rgb(148, 163, 184)"
